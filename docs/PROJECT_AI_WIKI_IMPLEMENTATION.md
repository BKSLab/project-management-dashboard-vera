...
> Исторический отчёт на 1 сентября. С 7 сентября 2026 года каталог, индексация, FTS, чтение агентом и проверка покрытия работают по [единому механизму знаний проекта](UNIFIED_PROJECT_KNOWLEDGE.md). Описанные ниже отдельные обработчики и лимит извлечения текста больше не используются.
