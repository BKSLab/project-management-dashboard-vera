...
@pytest.mark.asyncio
async def test_sticker_write_endpoints_pass_revision_and_coordinates(api_client: AsyncClient) -> None:
    """PATCH и DELETE передают ревизию, перенос передаёт координаты и отклоняет выход за диапазон."""
...
@pytest.mark.asyncio
async def test_member_avatar_answers_only_for_current_member_with_avatar(api_client: AsyncClient) -> None:
    """Аватар участника отдаётся с приватным кешем; исключённый участник и участник без аватара дают 404."""
