...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("PM", "BE", "FE", "UXR", "UXD", "EXPERT", "QA", "BA", "MKT", name="wbs_role"),
            nullable=True,
        ),
        sa.Column("order_index", sa.Integer(), nullable=False),
...
def downgrade() -> None:
    ...
    sa.Enum(name="task_activity_event_type").drop(op.get_bind(), checkfirst=True)
    sa.Enum(name="wbs_role").drop(op.get_bind(), checkfirst=True)
    # ### end Alembic commands ###
